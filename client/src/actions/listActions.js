...
export const getList = () => (dispatch) => {
  axios.get("/api/lists", { withCredentials: true }).then((res) =>
    dispatch({
      type: GET_LIST,
      payload: res.data,
    })
...
export const deleteOneList = (id) => (dispatch) => {
  axios.delete("/api/lists/" + id, { withCredentials: true }).then((res) =>
    dispatch({
      type: DELETE_LIST,
      payload: id,
    })
...
export const deleteOneTodo = (listId, todoId) => (dispatch) => {
  axios
    .delete("/api/lists/" + listId + "/todo/" + todoId, {
...
export const markDone = (listId, todoId, checklistId, isDone) => (dispatch) => {
  axios
    .put(
      "/api/lists/" + listId + "/todo/" + todoId + "/item/" + checklistId,
      { isDone: isDone },
      { withCredentials: true }
    )
    .then((res) =>
...
export const addDesc = (listId, todoId, desc) => (dispatch) => {
  axios
    .put(
      "/api/lists/" + listId + "/todo/" + todoId + "/desc",
      { desc: desc },
      { withCredentials: true }
    )
    .then((res) =>
